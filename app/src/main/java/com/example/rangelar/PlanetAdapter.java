...
public class PlanetAdapter extends RecyclerView.Adapter<PlanetAdapter.PlanetHolder> {
    ...
    private ArrayList<Planeta> planets;

    /*public PlanetAdapter(Context context, ArrayList<Planeta> planets) {
        this.context = context;
        this.planets = planets;
    }*/

    public PlanetAdapter(FirstFragment firstFragment, ArrayList<Planeta> planets) {
        this.context = context;
        this.planets = planets;
    }
    ...
    public PlanetHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.planetlayout, parent, false);
        return new PlanetHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PlanetHolder holder, int position) {
        Planeta planet = planets.get(position);
    ...
    class PlanetHolder extends RecyclerView.ViewHolder {
        ...
        void setDetails(Planeta planet) {
